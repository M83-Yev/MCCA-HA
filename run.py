...
#from inter_subject_decoder import inter_subject_decoder, permutation_test, averaged_inter_subject_correlation, \
#    plot_results
from inter_subject_decoder_HA import inter_subject_decoder, permutation_test, averaged_inter_subject_correlation
